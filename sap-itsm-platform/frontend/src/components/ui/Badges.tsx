...
const STATUS_MAP: Record<string, { label: string; classes: string }> = {
  ...
  IN_UAT:            { label: 'In UAT',             classes: 'bg-teal-100 text-teal-800' },
  HOLD:              { label: 'Hold',                classes: 'bg-pink-100 text-pink-800' },
  DEVELOPMENT_COMPLETED: { label: 'Development Completed', classes: 'bg-violet-100 text-violet-800' },
  MOVED_TO_QUALITY:  { label: 'Moved to Quality',    classes: 'bg-sky-100 text-sky-800' },
  MOVED_TO_PRODUCTION: { label: 'Moved to Production', classes: 'bg-lime-100 text-lime-800' },
